    ...
    <div className="flex flex-col bg-[#0f0f10] text-gray-100 h-screen overflow-hidden">
      ...
      <div className="px-2 md:px-4 py-1.5 border-b border-gray-800 flex-shrink-0 bg-[#0f0f10]">
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-2 flex-1 min-w-0">
            ...
            <button title="Refresh screen" onClick={refreshScreen} className="p-1 rounded bg-gray-700 hover:bg-gray-600 text-gray-300 flex-shrink-0 text-xs">↻</button>
          </div>
      ...
      <div className={`flex-1 flex ${isFullscreen?'flex-col':'flex-col lg:flex-row'} overflow-hidden min-h-0 gap-2 p-2`}>
        ...
        <div className={`${isFullscreen?'w-full h-full':'w-full lg:w-[65%]'} flex flex-col min-h-0`}>
          ...
          <div ref={viewerRef} className={`relative w-full ${isFullscreen?'flex-1':'h-[500px] flex-shrink-0'} border border-gray-800 rounded bg-black overflow-hidden`} 
