    ...
    <div className="flex flex-col bg-[#0f0f10] text-gray-100 overflow-x-hidden" style={{ height: '100dvh' }}>
      ...
      <div className="px-4 md:px-6 py-3 md:py-4 border-b border-gray-800 flex-shrink-0 bg-[#0f0f10] sticky top-0 z-10">
        <div className="flex items-center justify-between">
          ...
          {/* Compact controls row for mobile (moved below viewer) */}
      ...
      <div className="px-4 md:px-6 py-3 md:py-4 border-b border-gray-800 flex-shrink-0">
        <div className="relative w-full h-72 md:h-[420px] border border-gray-800 rounded bg-black/60 overflow-hidden flex items-center justify-center pb-10">
          {/* Quick test controls */}
          <div className="absolute top-2 left-2 right-2 hidden md:flex items-center gap-2 flex-wrap z-10 pointer-events-auto">
